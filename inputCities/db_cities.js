...
document.addEventListener('DOMContentLoaded', () => {
    ...
    alertBlock.textContent = 'Выберите язык';
    alertBlock.style.cssText = 'position:absolute, height:200px, width:200px';
    document.body.insertAdjacentElement('afterend',alertBlock);
    // alert('Выберите язык');
});

const selectCities = document.getElementById('select-cities');
selectCities.addEventListener('click', () =>{
    document.querySelector('dropdown-lists__list--default').display = 'block';
});
